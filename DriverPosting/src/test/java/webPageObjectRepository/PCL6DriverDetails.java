...
public class PCL6DriverDetails {
	...
	public static By PCLAgree = By.xpath("(//span[contains(@class,'xrx-fw-terms-conditions__text')][normalize-space()='I agree to the'])[1]");
	public static By PDLAgree=By.xpath("//span[@class='xrx-fw-terms-conditions__text']");
