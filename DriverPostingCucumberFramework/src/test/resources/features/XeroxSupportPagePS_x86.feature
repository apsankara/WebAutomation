...
Feature: Test XeroxSupportHomePage for PS_x86bit
  ...
  Scenario Outline: GPD PS_x86bit Driver Link Availability
    ...
    Examples: 
      ...
      | Windows 7           | English (Global) | GPD | Released: 06/23/2022 | Version: 5.887.3.0 | Size: 40.36 MB | Filename: UNIV_5.887.3.0_PS_x86.zip | Tags: GPD, Package-Aware, PostScript, V3 Driver, WHQL |
      | Windows 8           | English (Global) | GPD | Released: 06/23/2022 | Version: 5.887.3.0 | Size: 40.36 MB | Filename: UNIV_5.887.3.0_PS_x86.zip | Tags: GPD, Package-Aware, PostScript, V3 Driver, WHQL |
      | Windows 8.1         | English (Global) | GPD | Released: 06/23/2022 | Version: 5.887.3.0 | Size: 40.36 MB | Filename: UNIV_5.887.3.0_PS_x86.zip | Tags: GPD, Package-Aware, PostScript, V3 Driver, WHQL |
      | Windows Server 2008 | English (Global) | GPD | Released: 06/23/2022 | Version: 5.887.3.0 | Size: 40.36 MB | Filename: UNIV_5.887.3.0_PS_x86.zip | Tags: GPD, Package-Aware, PostScript, V3 Driver, WHQL |    
